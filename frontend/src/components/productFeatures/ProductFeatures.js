...
export const ProductFeatures = () => {
  const mainFeatures = data.attributes.filter(attribute => attribute.attribute_group_id === "");
  const otherFeatures = data.attributes.filter(attribute => attribute.attribute_group_id === "OTHERS");
